  ...
  return (
    <div className="flex flex-1 flex-col">
      ...
      <div className="flex flex-col bg-surface-inverse text-fg-inverse">
        <header className="animate-enter mx-auto flex w-full max-w-content items-center justify-between gap-4 px-4 py-6 sm:px-6">
        ...
        */}
        <main className="mx-auto grid w-full max-w-content items-center gap-12 px-4 py-12 sm:px-6 lg:min-h-[34rem] lg:grid-cols-[minmax(0,1.05fr)_minmax(0,1fr)] lg:py-20">
          <div className="flex flex-col items-start gap-6">
            <h1 className="animate-enter max-w-xl text-hero font-semibold [--enter-delay:90ms]">
              Power prices and weather, hour by hour
            </h1>

            <p className="animate-enter max-w-md text-lg leading-relaxed text-fg-inverse-muted [--enter-delay:180ms]">
            ...
            */}
            <div className="animate-enter mt-2 [--enter-delay:270ms]">
              <Suspense
          ...
          {/*
            Enters last, so the eye lands on the headline before the scene starts moving.
            Drop a licensed clip into public/ and pass videoSrc to swap the animation for
            it; nothing else needs to change.
          */}
          <div className="animate-enter [--enter-delay:340ms]">
            <HeroVisual />
          </div>
        </main>
      </div>
